...
// Flag/var defines
// These values must refer to unused flag/var slots. Adjust as needed based on your project's flag layout.
#define DN_FLAG_SEARCHING             0x800 // Searching for mon (temporary flag)
#define DN_FLAG_DEXNAV_GET            0x801 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x802 // Allow player to find hidden mons
#define DN_VAR_SPECIES                0x4200 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           0x4201 // Steps for finding hidden pokemon
