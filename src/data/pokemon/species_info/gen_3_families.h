...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_ATHENIAN, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ralts"),
        .cryId = CRY_RALTS,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_AMPLIFIER, ABILITY_RATTLED },
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_AMPLIFIER, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KEEN_EYE, ABILITY_VAMPIRIC, ABILITY_PRANKSTER },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_VAMPIRIC, ABILITY_PRANKSTER },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FOUNDRY, ABILITY_ANGER_POINT },
    #else
